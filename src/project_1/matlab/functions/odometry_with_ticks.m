function X_odom = odometry_with_ticks(R, LW, T, N, wheels, start_pos)
    % odometry_with_ticks Compute the robot odometry.
    %   Parameters:
    ...
    %       start_pos: Robot start position [x; y; theta]
